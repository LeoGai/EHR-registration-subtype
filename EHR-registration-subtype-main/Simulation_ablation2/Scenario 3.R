...
saveRDS(Reg_Simu3, file = paste0("./EHR-registration-subtype-main/Simulation_ablation2/FReg_Simu", 3, ".rds"))

saveRDS(Result3, file = paste0("./EHR-registration-subtype-main/Simulation_ablation2/FMatrix_Simu", 3, ".rds"))
