...
saveRDS(Reg_Simu5, file = paste0("./EHR-registration-subtype-main/Simulation_ablation2/FReg_Simu", 5, ".rds"))

saveRDS(Result5, file = paste0("./EHR-registration-subtype-main/Simulation_ablation2/FMatrix_Simu", 5, ".rds"))
