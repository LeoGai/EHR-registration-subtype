...
saveRDS(Reg_Simu2, file = paste0("./EHR-registration-subtype-main/Simulation_ablation2/FReg_Simu", 2, ".rds"))

saveRDS(Result2, file = paste0("./EHR-registration-subtype-main/Simulation_ablation2/FMatrix_Simu", 2, ".rds"))
