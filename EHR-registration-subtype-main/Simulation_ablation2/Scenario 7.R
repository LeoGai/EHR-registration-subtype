...
saveRDS(Reg_Simu7, file = paste0("./EHR-registration-subtype-main/Simulation_ablation2/FReg_Simu", 7, ".rds"))

saveRDS(Result7, file = paste0("./EHR-registration-subtype-main/Simulation_ablation2/FMatrix_Simu", 7, ".rds"))
