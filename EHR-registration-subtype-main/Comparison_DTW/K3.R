...
reg_simu <- function(seednum) {
  ...
  data$GroupCategory <- with(data,
                             ifelse(ID <= 300, "Group 1",                             
                                    ifelse(Scale >= 0.85, "Group 2",                     
                                           ifelse(Scale < 0.85, "Group 3", "Group 1")         
                                    )
                             )
  )
...
saveRDS(Reg_k3, file = paste0("./EHR-registration-subtype-main/Comparison_DTW/Reg_k3",".rds"))
...
print(summary_stats_k3)

saveRDS(summary_stats_k3, file = paste0("./EHR-registration-subtype-main/Comparison_DTW/summary_stats_k3", ".rds"))