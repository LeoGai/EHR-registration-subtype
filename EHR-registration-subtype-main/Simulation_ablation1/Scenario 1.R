...
saveRDS(Reg_Simu1, file = paste0("./EHR-registration-subtype-main/Simulation_ablation1/FReg_Simu", 1, ".rds"))

saveRDS(Result1, file = paste0("./EHR-registration-subtype-main/Simulation_ablation1/FMatrix_Simu", 1, ".rds"))
