...
saveRDS(Reg_Simu4, file = paste0("./EHR-registration-subtype-main/Simulation_ablation1/FReg_Simu", 4, ".rds"))

saveRDS(Result4, file = paste0("./EHR-registration-subtype-main/Simulation_ablation1/FMatrix_Simu", 4, ".rds"))
