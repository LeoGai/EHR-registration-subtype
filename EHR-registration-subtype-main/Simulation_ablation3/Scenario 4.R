...
saveRDS(Reg_Simu4, file = paste0("./EHR-registration-subtype-main/Simulation_ablation3/FReg_Simu", 4, ".rds"))

saveRDS(Result4, file = paste0("./EHR-registration-subtype-main/Simulation_ablation3/FMatrix_Simu", 4, ".rds"))
