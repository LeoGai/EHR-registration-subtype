...
saveRDS(Reg_Simu8, file = paste0("./EHR-registration-subtype-main/Simulation_ablation3/FReg_Simu", 8, ".rds"))

saveRDS(Result8, file = paste0("./EHR-registration-subtype-main/Simulation_ablation3/FMatrix_Simu", 8, ".rds"))
