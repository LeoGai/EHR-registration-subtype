...
saveRDS(Reg_Simu6, file = paste0("./EHR-registration-subtype-main/Simulation_ablation3/FReg_Simu", 6, ".rds"))

saveRDS(Result6, file = paste0("./EHR-registration-subtype-main/Simulation_ablation3/FMatrix_Simu", 6, ".rds"))
