...
saveRDS(Reg_Simu2, file = paste0("./EHR-registration-subtype-main/Simulation_ablation3/FReg_Simu", 2, ".rds"))

saveRDS(Result2, file = paste0("./EHR-registration-subtype-main/Simulation_ablation3/FMatrix_Simu", 2, ".rds"))
