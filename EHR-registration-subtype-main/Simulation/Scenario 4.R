...
saveRDS(Reg_Simu4, file = paste0("./EHR-registration-subtype-main/Simulation/FReg_Simu", 4, ".rds"))

saveRDS(Result4, file = paste0("./EHR-registration-subtype-main/Simulation/FMatrix_Simu", 4, ".rds"))
