...
library(patchwork)
  ...
  data1 <- data[
    data$Time >= start_time & data$Time <= 17 &
      !(data$ID > 750 & data$Time >= 17 * 0.7),
  ]
...
library(patchwork)
combined_plot_S7 <- p2 |p3 | p1  
  
ggsave(filename = "./EHR-registration-subtype-main/Simulation/Figs/NEWFIGS/NEWFig_S7.png",
