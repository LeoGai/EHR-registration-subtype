...
saveRDS(Reg_Simu5, file = paste0("./EHR-registration-subtype-main/Simulation/FReg_Simu", 5, ".rds"))

saveRDS(Result5, file = paste0("./EHR-registration-subtype-main/Simulation/FMatrix_Simu", 5, ".rds"))
