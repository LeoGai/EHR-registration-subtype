...
saveRDS(Reg_Simu2, file = paste0("./EHR-registration-subtype-main/Simulation/FReg_Simu", 2, ".rds"))

saveRDS(Result2, file = paste0("./EHR-registration-subtype-main/Simulation/FMatrix_Simu", 2, ".rds"))
