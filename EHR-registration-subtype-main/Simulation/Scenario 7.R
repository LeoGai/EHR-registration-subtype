...
saveRDS(Reg_Simu7, file = paste0("./EHR-registration-subtype-main/Simulation/FReg_Simu", 7, ".rds"))

saveRDS(Result7, file = paste0("./EHR-registration-subtype-main/Simulation/FMatrix_Simu", 7, ".rds"))
